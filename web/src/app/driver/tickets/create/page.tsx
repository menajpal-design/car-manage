    ...
    <div className="w-full min-h-screen bg-slate-950 text-slate-100 font-sans antialiased p-4">
      ...
      {!isOnline && (
        <div className="bg-amber-600 text-amber-50 px-4 py-3 text-xs font-semibold flex items-center gap-2 shadow-md animate-pulse">
          ...
          <span>Offline Mode. Issues will sync automatically when back online.</span>
        </div>
      )}
              ...
              {audioUrl && (
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-2 rounded bg-slate-900 hover:bg-slate-850 text-slate-355"
                  >
                  ...
                  <button
                    ...
                    className="p-2 rounded bg-rose-950/10 text-rose-455 hover:bg-rose-950/30"
                  >
