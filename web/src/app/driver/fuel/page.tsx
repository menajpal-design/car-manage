...
export default function DriverFuelPage() {
  ...
  return (
    <div className="w-full min-h-screen bg-slate-950 text-slate-100 font-sans antialiased">
      ...
      {!isOnline && (
        <div className="bg-amber-600 text-amber-50 px-4 py-3 text-xs font-semibold flex items-center gap-2 shadow-md animate-pulse">
      ...
      {/* Main Container */}
      <div className="max-w-xl mx-auto p-4 md:p-6 space-y-4 pb-12">
        ...
        <div className="flex items-center gap-2 border-b border-slate-900 pb-3">
          ...
          <div>
            ...
            {vehicle && <p className="text-[10px] text-slate-500 font-semibold">Assigned Vehicle: {vehicle.regNumber}</p>}
          </div>
        </div>
          ...
          <div className="bg-violet-600/10 border border-violet-600/20 p-3 rounded-xl flex items-center justify-between text-xs text-violet-400 font-medium">
            ...
            {isOnline && (
              <button 
                ...
                className="bg-violet-600 hover:bg-violet-500 text-white font-semibold px-3 py-1 rounded-lg transition-colors"
              >
                Sync Now
              </button>
            )}
        ...
        <form onSubmit={handleFormSubmit} className="space-y-4">
          ...
          <div className="bg-slate-900/40 border border-slate-900 p-4 rounded-xl space-y-3.5">
            <div className="flex items-center justify-between text-xs text-slate-400 font-bold uppercase tracking-wide">
              ...
              <span className="text-slate-555">Prev: {previousOdo} km</span>
            </div>
          ...
          <div className="bg-slate-900/40 border border-slate-900 p-4 rounded-xl space-y-4">
            <h3 className="text-xs text-slate-450 font-bold uppercase tracking-wide">Fuel details</h3>
          ...
          <div className="bg-slate-900/40 border border-slate-900 p-4 rounded-xl space-y-3">
            <h3 className="text-xs text-slate-450 font-bold uppercase tracking-wide">Odometer Photo Capture</h3>
