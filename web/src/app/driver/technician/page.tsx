...
export default function TechnicianDashboard() {
  ...
  return (
    <div className="w-full min-h-screen bg-slate-950 text-slate-100 font-sans antialiased p-4">
      <div className="max-w-xl mx-auto space-y-4 pb-12">
        ...
        <div className="flex items-center gap-2 border-b border-slate-900 pb-3">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-500 font-semibold">Technician: {techName}</p>
          </div>
        </div>
        ...
        {error && (
          <div className="flex items-center gap-2 p-4 rounded-xl bg-rose-500/10 border border-rose-500/20 text-rose-400 text-xs font-semibold animate-in fade-in">
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            <h3 className="text-xs font-bold text-slate-450 uppercase tracking-wide">My Assigned Tickets ({tickets.length})</h3>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 border-b border-slate-900 pb-3">
              ...
              <span className="text-xs font-semibold text-slate-400">Log Solution</span>
            </div>
            ...
            <form onSubmit={handleSolutionSubmit} className="space-y-4">
              ...
              <div className="bg-slate-900/40 border border-slate-900 p-4 rounded-xl space-y-4">
                <h3 className="text-xs text-slate-450 font-bold uppercase tracking-wide">Maintenance Cost Logs</h3>
                
                <div className="space-y-1">
                  <label className="text-2xs font-bold text-slate-550 uppercase tracking-wide">Labor Cost ($)</label>
                  <input
                    type="number"
                    step="0.01"
                    required
                    ...
                    className="h-11 w-full rounded-lg bg-slate-950 border border-slate-800 focus:border-violet-500 outline-none px-3 text-sm text-slate-250 font-bold"
                  />
                </div>
              </div>
              ...
              <div className="bg-slate-900/40 border border-slate-900 p-4 rounded-xl space-y-3">
                <div className="flex items-center justify-between">
                  <h3 className="text-xs text-slate-450 font-bold uppercase tracking-wide">Parts Replaced</h3>
                  <button
                    type="button"
